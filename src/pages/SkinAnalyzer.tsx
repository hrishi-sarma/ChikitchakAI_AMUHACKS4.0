  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        setRotation(0);
        toast({
          title: "Skin image uploaded",
          description: "Your skin image has been uploaded successfully. Click 'Analyze Skin' to continue."
        });
      };
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your skin image has been analyzed. View the detailed results in the right panel."
      });
    } catch (error) {
  ...
  const ImageViewerPanel = () => (
    <div className="h-full flex flex-col">
      <div className="p-4 border-b">
        <h3 className="font-medium mb-2">Skin Analyzer</h3>
      ...
      <div className="flex-1 flex items-center justify-center bg-black/10 dark:bg-black/30 overflow-hidden relative">
        {uploadedImage ? (
          ...
          <div className="text-center p-6">
            <p className="text-muted-foreground">
              Upload a skin image to view it here
            </p>
          </div>
        )}
        ...
        {analyzing && (
          <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white">
            <div className="text-center">
              <p className="mb-4">AI analyzing your skin image...</p>
              <div className="flex space-x-2">
            ...
            <div className="px-6 pb-6">
              {!analysisResult ? (
                <div className="h-64 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-muted-foreground">
                    {analyzing 
                      ...
                      : uploadedImage 
                        ? "Click 'Analyze Skin' to get results" 
                        : "Upload a skin image to see analysis results"}
                  </p>
                  {analyzing && (
                ...
                <div className="space-y-6">
                  <div className="bg-medease-50 dark:bg-medease-900/30 rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <h3 className="font-medium text-lg">
                        Identified Condition: {analysisResult.prediction}
                      </h3>
                  ...
                  <div>
                    <h3 className="font-medium mb-2">Skin Condition Information</h3>
                    {analysisResult.prediction && (
                      <div className="border rounded-lg p-4">
                        <p className="mb-2">
                          The analysis identifies this as <strong>{analysisResult.prediction}</strong>.
                        </p>
                        <p>
                          The AI model was trained to detect various skin conditions and provides its confidence level for each category. The highest confidence prediction is shown first along with alternative possibilities.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <Button 
                      ...
                      onClick={() => toast({
                        title: "Report shared",
                        description: "Your skin analysis report has been shared with your doctor."
                      })}
                    >
                    ...
                    <Button 
                      ...
                      onClick={() => toast({
                        ...
                        description: "Your skin analysis report has been downloaded."
                      })}
                    >
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg text-sm">
                    <div className="flex items-start">
                      ...
                      <p>
                        This AI analysis is for informational purposes only and should not replace professional medical diagnosis. Always consult with a qualified healthcare provider for proper interpretation of the analysis.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <TabsContent value="guide" className="flex-1 overflow-auto">
          <ScrollArea className="h-full">
            <div className="px-6 pb-6 space-y-6">
              <div>
                <h3 className="font-medium mb-2">How to Use the Skin Analyzer</h3>
                <ol className="list-decimal pl-5 space-y-3">
                  <li>Upload a clear, high-resolution skin image using the upload button.</li>
                  <li>Ensure the image is well-lit and the area of interest is clearly visible.</li>
                  <li>Click "Analyze Skin" to begin the AI analysis process.</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>This analyzer is designed to work with skin images.</li>
                  <li>It can detect various skin conditions from properly captured images.</li>
                  <li>For best results, use clear, well-focused images in JPEG or PNG format.</li>
                </ul>
              </div>
              ...
              <div className="bg-medease-50 dark:bg-medease-900/30 p-4 rounded-lg">
                ...
                <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                  <li>Use high-quality digital images for best analysis results.</li>
                  <li>Ensure the skin area is free from obstructions (e.g., makeup, hair) if possible.</li>
                  <li>Upload the highest quality image available.</li>
                  <li>Consult with a dermatologist or appropriate specialist for official diagnosis.</li>
                </ul>
              </div>
